...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript" src="js/securityPass.js">
			...
			<div class="main">
				...
				<div class="layout order">
					...
					<div class="lay-bd">
						<div class="safe">
							<h2>密码修改</h2>
							<form id="_editLoginPwd" method="post" action="PassengerServlet?method=updPass" >
								<ul class="safe-list">
									<li>
										<div class="label"><span class="required">*</span> 原密码：
										</div>
										<div class="r-txt"><input id="password" name="password" type="password" class="inptxt w200 color333" maxlength="25" />
										</div>
										<div class="tips">请输入原密码</div>
									</li>
									<li>
										<div class="label"><span class="required">*</span> 新密码：
										</div>
										<div class="r-txt">
									...
									<li>
										...
										<label for="password_new" class="error" id="npw" style="display: none;margin-left: 210px;">密码只能为字母和数字或下划线中的两个的组合！</label>
									</li>
									<li>
									...
									<li>
										<div class="label"><span class="required">*</span> 密码确认：
										</div>
										<div class="r-txt"><input id="confirmPassWord" name="confirmPassWord" type="password" class="inptxt w200 color333" value="" maxlength="25" />
										</div>
										<div class="tips">请再次输入密码。</div>
									</li>
									<li style="display: list-item;">
										<div class="label"><span class="required"></span></div>
										<label for="confirmPassWord" class="error" id="rnp" style="display: none;margin-left: 210px;">您输入的确认密码与新密码不一致</label>
									</li>
									<li>
							...
							<div class="line"></div>
							<div class="lay-btn">
								<input value="取消" type="reset" style="border: none" class="btn92" shape="rect">
								<input value="确认" type="submit" style="border: none" class="btn92s" shape="rect">
							</div>
						</div>
					</div>
				</div>
