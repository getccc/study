...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="css/my12306.css" rel="stylesheet" />
		...
		<div class="content clearfix">
			...
			<div class="main">
				...
				<div class="layout order">
					...
					<div class="lay-bd">
						<div class="welcome">
							<div class="welcome-bd" style="width:552px;"><span class="icon i-hi"></span>
								<div id="my12306page" class="r-txt" style="margin-left:112px;">
									<h3><span>${passenger.realName}</span>
先生，下午好！</h3>
									<p>欢迎您登录中国铁路客户服务中心网站。<br clear="none" /> 如果您需要预订车票，请您点击
										<a href="#nogo" shape="rect">车票预订</a>
										。</p>
								</div>
							</div>
						</div>
						<div class="welcome-ft">您的
							<a id="link_for_infor" href="#nogo" shape="rect">个人信息</a>
							还不够完善，是否要进行资料补充。
							<a id="link_for_edit" href="#nogo" class="btn92" shape="rect"><span class="i-editbtn">编辑</span>
							</a>
						</div>
					</div>
				</div>
