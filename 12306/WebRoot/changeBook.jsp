		...
		<div class="content" style="min-height: 421px;">
			...
			<div class="layout person">
				...
				<div class="lay-bd">
					...
					<form id="form_select" action="OrderServlet?method=changeOrder"
						method="post">
						...
						<table class="per-ticket">
							...
							<c:forEach items="${changePassengers}" var="changePassengers">
								<tr id="tr_id_1">
									<td align="left">
										1
									</td>
									...
									<td>
										<div class="pos-rel">
											<input id="passenger_name_1" class="inptxt w110"
												...
												maxlength="20" value="${changePassengers.realName}" >
									...
									<td>
										<div class="pos-rel">
											<input id="passenger_id_no_1" name="passenger_id_card_1"
												class="inptxt w160"  value="${changePassengers.card}"
												onkeyup="javascript:elemOnkeyupNotice(this);"
									...
									<td>
										<div class="pos-rel">
											<input id="phone_no_1" class="inptxt w110"
												...
												maxlength="20" value="${changePassengers.tel}" >
