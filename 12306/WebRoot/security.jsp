...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript" src="js/security.js">
		...
		<div class="content clearfix">
			...
			<div class="main">
				...
				<div class="layout order">
					...
					<div class="lay-bd">
						<div class="safe-item">
							<div class="left"><span class="icon-safe login-pass login-pass-ok"></span>
								<div>登录密码</div>
							</div>
							<div class="right">
								<a href="securityPass.jsp" id="ling_4_login_pwd" class="btn92" shape="rect">修改</a>
								<p>建议您定期更改密码以保护账户安全。</p>
							</div>
						</div>
						<div class="safe-item">
							<div class="left"><span class="icon-safe email"></span>
								<div>安全邮箱</div>
							</div>
							<div class="right">
								<a href="securityEmail.jsp" id="ling_4_email" class="btn92" shape="rect">修改</a>
								<p>使用邮箱接收铁路客户服务信息</p>
							</div>
						</div>
						<div class="safe-item">
							<div class="left"><span class="icon-safe tel tel-ok"></span>
								<div>手机核验</div>
							</div>
							<div class="right">
								<a href="securityTel.jsp" id="ling_4_tel" class="btn92" shape="rect">修改</a>
								<p>使用手机接收铁路客户服务信息</p>
							</div>
						</div>
						<div class="safe-item">
							<div class="left"><span class="icon-safe dj-pass dj-pass-ok"></span>
								<div>兑奖密码</div>
							</div>
							<div class="right">
								<a href="javascript:" id="ling_4_integration_pwd" class="btn92" shape="rect">修改</a>
								<p>积分购票时，需要验证使用的密码</p>
							</div>
						</div>
					</div>
