...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <script type="text/javascript">
	...
	<body class="emp_body">
		...
		<form id="search_form" method="post" action="<%=basePath%>staff/editStaff">
			<tr>
				<td>
					登录名：
				</td>
				<td>
					<input  value="${updatestaff.loginName}" name="loginName" type="text" />
				</td>
				<td>
					登陆密码：
				</td>
			...
			<tr>
				...
				<td>
					<input value="${updatestaff.staffName}" name="staffName" type="text" />
				</td>
				<td>
					性别：
				</td>
			...
			<tr>
				...
				<td width="20%">
					<select id="dept" >
						...
						<option value="${updatestaff.post.department.depId}">
							${updatestaff.post.department.depName}
						</option>
			...
			<tr>
				...
				<td width="20%">
					<input  value="${updatestaff.onDutyDate}" name="onDutyDate" type="text" />
				</td>
				<td width="8%"></td>
				<td width="62%"></td>
			</tr>
