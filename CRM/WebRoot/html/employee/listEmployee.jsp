...
<table border="0" cellspacing="0" cellpadding="0" class="wukuang">
  <tr>
    ...
    <td width="63%"align="right">
        <a class="butbg"  href="addEmployee.html"><img src="../../images/button/tianjia.gif" /></a>
...
<table width="100%" border="1" >
  ...
  <tr class="tabtd2">
	...
	<td width="8%" align="center"><a href="editEmployee.html"><img src="../../images/button/modify.gif" class="img"></a></td>
	<td width="8%" align="center"><a href="editEmployee.html"><img src="../../images/button/view.gif" class="img"></a></td>
  </tr>
  <tr class="tabtd1">
